  ...
  return (
    <section className="text-center">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Quotes.md.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Quotes.md, accessible from{" "}
            <a
              href="https://quotes-md.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://quotes-md.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        USD if You havent purchased anything through the Service.
      </p>
      <p>
      ...
      <p>
        ...
        each partys liability will be limited to the greatest extent permitted
        by law.
      </p>
      ...
      <p>
        ...
        companys provider makes any representation or warranty of any kind,
      ...
      <ul>
        <li>By email: icarog854@gmail.com</li>
      </ul>
    </section>
  );
}
